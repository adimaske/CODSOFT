...
task_entry.focus()
button = Button(frame, text="ADD", font="Arial 18 bold", width=6, bg="#FF6F61", fg="#fff", bd=0, command=task_add)
...
Button(root, image=Delete_icon, bd=0, command=task_delete).pack(side=BOTTOM, pady=20)
